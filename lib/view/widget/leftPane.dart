                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(
                                    Uri.parse("https://github.com/nisone"));
                              },
                              onHover: (bol) {
                                if (bol) {
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse(
                                    "https://www.linkedin.com/in/insambo/"));
                              },
                              onHover: (bol) {
                                if (bol) {
                                  ref.read(hoverProvider.notifier).state =
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(
                                    Uri.parse("https://twitter.com/nuhu94"));
                              },
                              onHover: (bol) {
                                if (bol) {
                                  ref.read(hoverProvider.notifier).state =
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse(
                                    "https://stackoverflow.com/users/11420827/nuhu-ibrahim"));
                              },
                              onHover: (bol) {
                                if (bol) {
                                  ref.read(hoverProvider.notifier).state =
